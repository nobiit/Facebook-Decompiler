...
.method public constructor <init>(LX/2aX;)V
    ...
    .line 2
    .line 3
    iput-object p1, p0, LX/1yC;->A00:LX/2aX;
...
# virtual methods
.method public A00(Lcom/google/common/collect/ImmutableMap;LX/3Sv;)Ljava/util/HashMap;
    .locals 4
    ...
    invoke-virtual {p2}, LX/3Sv;->A00()Ljava/util/List;
    ...
    :cond_1
    const-string/jumbo v1, "tracking_nodes"
    ...
    :cond_2
    const-string v3, "browser_metrics_join_key"
    ...
    instance-of v0, p2, LX/3Sv;

    if-eqz v0, :cond_3

    iget-boolean v1, p2, LX/3Sv;->A01:Z
    ...
    :cond_5
    const-string v1, "is_open_application"
    ...
    :cond_8
    const-string v1, "attachment_style_subtype"
