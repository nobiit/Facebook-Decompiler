...
.method public final D2X(LX/0F9;LX/0Ui;)V
    ...
    .line 1
    .line 2
    iget v1, p1, LX/0Hx;->acraActiveRadioTimeS:I
    ...
    .line 11
    :cond_0
    iget v1, p1, LX/0Hx;->acraTailRadioTimeS:I
    ...
    .line 20
    :cond_1
    iget v1, p1, LX/0Hx;->acraRadioWakeupCount:I
    ...
    .line 29
    :cond_2
    iget-wide v3, p1, LX/0Hx;->acraTxBytes:J
    ...
    .line 38
    .line 39
    invoke-interface {p2, v0, v3, v4}, LX/0Ui;->AQp(Ljava/lang/String;J)V
